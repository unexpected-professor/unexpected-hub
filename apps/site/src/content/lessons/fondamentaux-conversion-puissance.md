---
title: "Fondamentaux de la conversion de puissance"
summary: >-
  De la source directe au convertisseur Buck : pourquoi la valeur moyenne et la
  valeur efficace diffèrent, et comment le plan tension-courant permet de suivre
...
1. Connexion directe : source `E` et charge `R`.
2. Résistance série : ajout de `Rth`.
3. Interrupteur commandé : courant pulsé, valeur efficace différente de la
   valeur moyenne.
